...
public class PocTest1 {
    ...
    public static class NatsIntegrationConfiguration {
        ...
        private String topic = "cats" ;

        private String hostUri = "nats://localhost:4222";
        ...
        public NatsFactoryBean nats() {
            ...
            natsFactoryBean.setSubscriptions(new ArrayList<SubscriptionConfig>());
        ...
        @Bean
        public NatsInboundChannelAdapter natsInboundChannelAdapter2() throws Throwable {
    ...
    public static void main(String args[]) throws Throwable {
        ...
        AnnotationConfigApplicationContext ac = new AnnotationConfigApplicationContext(NatsIntegrationConfiguration.class);
